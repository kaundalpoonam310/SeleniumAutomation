...
public class LeavePolicySelectors {
    ...
    public static final String NEXT_STEP_BUTTON = "//button[contains(.,'Next step')]";
    public static final String SAVE_BUTTON = "//button[text()='Save']";

    // Success message
    public static final String CATEGORY_SUCCESS_MESSAGE = "//*[contains(text(),'Category created successfully')]";
    ...
    public static final String ACCRUAL_TYPE_SELECT = "//div[contains(@class,'ng-input')][1]";
    ...
    public static final String ACCRUAL_START_SELECT = "//div[contains(@class,'ng-input')][2]";
    ...
    public static final String RESTRICT_TOGGLE_TEXT = "//div[contains(text(),'restrict submission of leave requests')]/following-sibling::input";
    public static final String THRESHOLD_DAYS_INPUT = "//input[@placeholder='Enter number of days']";
    public static final String WEEKLY_TOGGLE = "//div[contains(text(),'include weekly off between leave days')]/following-sibling::input";
    public static final String WEEKLY_VALUE_INPUT = "//input[@placeholder='Enter a value']";
    public static final String HOLIDAY_TOGGLE = "//div[contains(text(),'include holiday between leave days')]/following-sibling::input";
    public static final String HOLIDAY_THRESHOLD_INPUT = "//input[@name='thresholdToIncludeHoliday']";
    public static final String POLICY_SUCCESS_MESSAGE = "//*[contains(text(),'Policy created successfully')]";
}
